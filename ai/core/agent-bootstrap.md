...
| `src/services/` | Vitest integration tests | `npm run test:integration` | External services |
| `src/app/` API routes | Vitest integration tests | `npm run test:integration` | External services |
...
- Any new DB model or migration

> Fill in integration test setup details in `ai/core/project-notes.md` when cloning.
